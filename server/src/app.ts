...
import { companyMcpServerOauthRoutes } from "./routes/company-mcp-servers-oauth.js";
...
import { instanceAiAuthRoutes } from "./routes/instance-ai-auth.js";
import {
...
export async function createApp(
  ...
  api.use(companyMcpServerOauthRoutes(db));
  ...
  api.use(instanceAiAuthRoutes(db));
