...
export const help: Record<string, string> = {
  ...
  httpMethod: "HTTP method used for the webhook request. Defaults to POST.",
  httpHeaders: "Headers sent with the webhook request. Use plain values or secret references (e.g. an Authorization bearer token).",
  httpTimeoutMs: "Maximum milliseconds to wait for the webhook response before aborting. 0 means no timeout.",
