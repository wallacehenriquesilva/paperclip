export const queryKeys = {
  ...
  agents: {
    ...
    scriptBundle: (id: string) => ["agents", "script-bundle", id] as const,
    scriptFile: (id: string, relativePath: string) =>
      ["agents", "script-bundle", id, "file", relativePath] as const,
  ...
  access: {
    ...
    boardApiKeys: ["access", "board-api-keys"] as const,
  },
  auth: {
